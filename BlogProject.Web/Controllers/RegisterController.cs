...
namespace BlogProject.Web.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> Register(UserRegisterVM userRegisterVM)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("BlogProject Admin", "umutoncel91@gmail.com");
            ...
            smtpClient.Authenticate("umutoncel91@gmail.com", "huhinaqpvdzpqskd");
